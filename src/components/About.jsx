    ...
    return(
        ...
        <main>
            ...
            <div className="about main-content">
             ...
             <Collapse title="Service" content={` Nos équipes se tiennent à votre disposition pour vous fournir une
                    expérience parfaite. N'hésitez pas à nous contacter si vous
                    avez la moindre question.`} />


             <Collapse title="Sécurité" content={`La sécurité est la priorité de Kasa. Aussi bien pour nos hôtes
